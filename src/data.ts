...
export const features = [
  {
    ...
    description:
      '한국 각 지역의 다양한 향토음식을 소개합니다. 각 지역의 특색 있는 음식에 대한 역사를 확인하세요.',
    link: '/localfood',
  ...
  },
  {
    ...
    description:
      '우리가 태어나 자란 지역의 역사와 함께 해온 그 시장, 기억하시나요? 과연 우리의 향토 시장에는 어떤 음식들이 있을까요?',
    link: '/localmarket',
  ...
  },
  {
    ...
    description:
      '식품 구매 전, 최고의 선택! 현재 구매를 고민하는 제품이 안전한 제품인지 확인해보세요! ',
    link: '/haccp',
  ...
  },
  {
    ...
    description:
      '방대한 식품 영양 데이터베이스를 통해 우리가 먹은 음식의 칼로리 정보를 확인하세요.',
    link: '/nutrition',
  ...
  },
  {
    ...
    description:
      '화려해 보이는 음식부터 단순한 음식까지 간단한 조리법으로 쉽고 편하게 조리해 보세요.',
    link: '/recipe',
  ...
  },
  {
    ...
    description:
      '한 번쯤 궁금할 수 있는 우리나라의 전통음식의 종류에 대한 정보를 제공합니다.',
    link: '/traditional',
