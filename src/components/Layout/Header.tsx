...
function Header() {
  ...
  return (
    <header className={`${isShow ? styles.active : ''} ${styles.Header}`}>
      <div className={styles.header_inner_bondary}>
        <h1
          title="사이트 로고"
          aria-label="클릭 시 홈으로 이동"
        ...
        <button
          ...
          className={`${styles.menu_icon} ${isShow ? styles.open_menu : ''}`}
        >
          {!isOpenModal ? <HiMenu /> : <HiXCircle />}
        </button>
