...
import LocalFoodContent from "../module/LocalFoodContent";
    ...
    <>
      ...
      >
        ...
        <ol className={styles.category} ref={categoryRef}>
          ...
          {title?.map((title,i) => {
            return <li key={i} onClick={searchFilter}>{title}</li>;
          })}
        </ol>
      ...
      {/* 디테일 내용 영역 */}
      <LocalFoodContent display={display} setDisplay={setDisplay} searchResult={searchResult}/>
