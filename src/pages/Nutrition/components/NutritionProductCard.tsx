...
const NutritionProductCard = forwardRef(
  ({ product, onNext, onPrev, index }: PropsType, ref: any) => {
    return (
      <div key={product.id} className={styles.product_card_boundary}>
        <div className={styles.product_card_control_btn_container}>
          <div className={styles.product_card_control_btn_inner_wrapper}>
            <button
              title="이전 슬라이드"
              aria-label="이전 슬라이드 버튼"
              className={styles.product_card_control_button}
