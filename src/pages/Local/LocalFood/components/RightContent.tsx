...
export default function RightContent({ info }: PropsType) {
    const { content_url, keyword, create_at, update_at, rel_rest_address, rel_rest_name, rel_rest_tel, lcc_address } = info
    return (
        <div className={styles.right_content}>
            ...
            <div className={styles.content}>
                ...
                {rel_rest_tel ? <span className={styles.rel_tel}><HiPhone /> {rel_rest_tel}</span> : null}
